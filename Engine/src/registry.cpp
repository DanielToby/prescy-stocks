...
void Registry::addIndicator(const StockIndicator &indicator) {
    API_CALL();
    _impl->addIndicator(indicator);
}

void Registry::updateIndicator(const StockIndicator &indicator) {
    API_CALL();
    _impl->updateIndicator(indicator);
}
